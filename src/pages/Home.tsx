        ...
        <section className="container mx-auto px-8 py-20 grid md:grid-cols-2 gap-12 items-center max-w-7xl">
          <div className="space-y-8">
            <h1 className="text-4xl md:text-5xl font-bold">
              ...
              <span className="text-blue-500 block mt-2">Natal RN</span>
            </h1>
            <p className="text-gray-600 text-lg">
              Descubra as mais belas praias do nordeste brasileiro. 
              Planeje sua viagem perfeita com as melhores opções de hospedagem e passeios.
            </p>
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-8 max-w-7xl">
            <div className="text-center mb-16 max-w-2xl mx-auto">
              <h2 className="text-3xl font-bold mb-6">Facilite a sua viagem</h2>
              <p className="text-gray-600 text-lg">
                Nós te ajudamos a encontrar as melhores opções para a sua viagem, 
                com todo o suporte que você precisa.
              </p>
            </div>
